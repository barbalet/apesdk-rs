...
BEGIN {
    ...
    bucket_names[5] = "random_state"
    minute_fields["brain_probe"] = "brain brainstate attention probe0 script shout"
    minute_fields["social"] = "social0 territory0 goal socialcoord family conception"
    minute_fields["episodic"] = "episodic0 attention"
    minute_fields["immune"] = "immune"
    minute_fields["random_state"] = "seed"
...

{
    ...
    printf 'covered=brain-probe-social-episodic-immune-random-minute-and-after-day-first-mismatch-classification\n'
    printf 'open=promote-brain-probe-social-episodic-immune-random-runtime-buckets-to-exact\n'
