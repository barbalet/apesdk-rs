...
run_expect "$ROOT/rust/target/debug/simape" "$COMMAND_DIR/command_fuzz_a.commands" "$RAW_DIR/rust/command_fuzz.txt"
"$ROOT/both/scripts/transport_normalize_transcript.sh" "$RAW_DIR/native/command_fuzz.txt" > "$TRANSPORT_DIR/native/command_fuzz.txt"
"$ROOT/both/scripts/transport_normalize_transcript.sh" "$RAW_DIR/rust/command_fuzz.txt" > "$TRANSPORT_DIR/rust/command_fuzz.txt"
