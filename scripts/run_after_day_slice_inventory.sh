...
BEGIN {
    ...
    fields["movement"] = "loc facing speed"
    fields["energy"] = "energy"
    fields["body"] = "mass awake state"
    fields["honor_drives"] = "honor drives preference"
...

{
    ...
    printf 'covered=day-one-selected-movement-energy-body-honor-drive-first-mismatch-classification\n'
    printf 'open=promote-open-day-one-movement-energy-honor-drive-buckets-to-exact\n'
