...
"$ROOT/scripts/run_after_day_drift_inventory.sh" "$OUT_DIR/after-day-drift"
"$ROOT/scripts/run_after_day_slice_inventory.sh" "$OUT_DIR/after-day-slices"
"$ROOT/scripts/run_brain_social_runtime_inventory.sh" "$OUT_DIR/brain-social-runtime"
