...
if [ -z "$RAW_VALUE_GATE_DIR" ]; then
    ...
    "$ROOT/scripts/run_native_raw_binary_value_gate.sh" "$RAW_VALUE_GATE_DIR" >/dev/null
fi
...

{
    ...
    printf 'covered=populated-native-raw-byte-first-diff-classification-and-mutation-check\n'
