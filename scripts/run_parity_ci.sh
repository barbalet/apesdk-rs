...
"$ROOT/scripts/build_native_simape.sh" "$NATIVE_DIR"
NATIVE_SIMAPE="$NATIVE_DIR/simape" RUST_SIMAPE="$ROOT/target/debug/simape" "$ROOT/scripts/run_cli_transcripts.sh" "$TRANSCRIPT_DIR"
