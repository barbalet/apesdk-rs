...
run_pipe "$ROOT/target/debug/simape" "$COMMAND_DIR/eof_quiet_command.commands" "$RAW_DIR/rust/eof_quiet_command.txt"
compare_canonical_case eof_quiet_command "$ROOT/scripts/canonicalize_closed_stdin_transcript.sh"

run_pipe "$NATIVE_DIR/simape" "$COMMAND_DIR/eof_verbose_command.commands" "$RAW_DIR/native/eof_verbose_command.txt"
run_pipe "$ROOT/target/debug/simape" "$COMMAND_DIR/eof_verbose_command.commands" "$RAW_DIR/rust/eof_verbose_command.txt"
compare_canonical_case eof_verbose_command "$ROOT/scripts/canonicalize_eof_verbose_command_transcript.sh"

run_pipe "$NATIVE_DIR/simape" "$COMMAND_DIR/eof_bounded_run.commands" "$RAW_DIR/native/eof_bounded_run.txt"
run_pipe "$ROOT/target/debug/simape" "$COMMAND_DIR/eof_bounded_run.commands" "$RAW_DIR/rust/eof_bounded_run.txt"
compare_canonical_case eof_bounded_run "$ROOT/scripts/canonicalize_eof_bounded_run_transcript.sh"

run_pipe "$NATIVE_DIR/simape" "$COMMAND_DIR/closed_stdin.commands" "$RAW_DIR/native/closed_stdin.txt"
run_pipe "$ROOT/target/debug/simape" "$COMMAND_DIR/closed_stdin.commands" "$RAW_DIR/rust/closed_stdin.txt"
compare_canonical_case closed_stdin "$ROOT/scripts/canonicalize_closed_stdin_transcript.sh"

run_expect "$NATIVE_DIR/simape" "$ROOT/golden/cli/sessions/timing_stop_forever.commands" "$RAW_DIR/native/timing_stop_forever.txt"
run_expect "$ROOT/target/debug/simape" "$ROOT/golden/cli/sessions/timing_stop_forever.commands" "$RAW_DIR/rust/timing_stop_forever.txt"
